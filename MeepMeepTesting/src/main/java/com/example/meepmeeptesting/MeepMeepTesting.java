...
//        double minusAngle = targetAngle - (curAngle - 360);
    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .setConstraints(60, 120, Math.toRadians(360), Math.toRadians(360), 14.35)
...
//                        .waitSeconds(3)
                        .back(6)
//                        .turn(Math.toRadians(-90))
                        .lineToLinearHeading(new Pose2d(0, -42, Math.toRadians(90)))
                        .back(6)
                        .turn(Math.toRadians(-90))
                        .forward(6)
                        ...
                        .back(48)
                        .forward(36)
                        .lineToConstantHeading(new Vector2d(54, -6))
                        .back(48)
                        .forward(36)
                        .lineToConstantHeading(new Vector2d(62, -6))
                        .back(48)
                        .build());
